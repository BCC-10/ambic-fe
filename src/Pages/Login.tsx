        ...
        <div className='relative flex flex-wrap items-center justify-center min-w-full min-h-screen flex-row-reverse '>
            <div className='relative lg:left-50 flex items-center justify-center p-2 w-auto h-auto flex-col bg-none rounded-lg drop-shadow-xl gap-5'>
                ...
                <div className="lg:hidden flex flex-col gap-5 items-center justify-center ">
                    <h1 className="text-teal-700/85 font-bold font-Poppins text-3xl">Welcome Back</h1>
                    <p className="text-teal-700/85 font-medium font-Poppins text-lg">Belum punya akun?</p>
                    ...
                    <Link to="/register" className="text-white w-full h-full flex items-center justify-center">
                    Daftar
                    </Link>
                    </button>
                </div>
            </div>
            <div className='bg-teal-700/85 w-full md:w-1/2 lg:w-2/5 absolute left-0 h-screen rounded-r-[300px] flex items-center justify-center flex-col gap-2 max-lg:hidden '>
