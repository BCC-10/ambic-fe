  ...
  return (
    <div className="card p-4 h-[90%] flex items-center justify-center flex-col w-full">
      ...
      <div className="p-fluid">
        ...
        <div className="mb-3">
          <div {...getRootProps()} className='relative w-full rounded-xl flex flex-col  cursor-pointer gap-3  max-sm:w-[79%] max-xl:w-[90%] '>
              <label className={`font-semibold font-Poppins text-teal-700/85`}>Masukkan Gambar Produk (Bila ada)</label>
              <div className={`w-full flex items-center px-8 py-5 max-sm:pl-14 border-2 border-dashed border-gray-400 hover:bg-gray-100 rounded-xl ${preview ? "flex-col gap-5" : ""}`}>
                  <input 
                      {...getInputProps()} 
                      type='file'
                      name='photo'
                  ...
                  <LuPackageOpen size={20} className='relative top-0 -left-3'/>
