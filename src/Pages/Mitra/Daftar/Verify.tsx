...
const Verify = () => {
    ...
    useEffect(() => {
        ...
        const verifyAccount = async () => {
            try {
                const response = await axios.post("https://ambic.live:443/api/v1/partners/verification", {token, email})
    ...
    return (
        ...
        <div className="bg-white p-6 rounded-lg shadow-lg text-center">
            <h2 className="text-2xl font-bold text-teal-600">Verifikasi Akun Mitra</h2>
